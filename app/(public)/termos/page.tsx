...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description: "Termos de uso da plataforma Blue Panda Travel.",
};
  ...
  return (
    <div className="pt-40 pb-20 bg-midnight min-h-screen">
      <div className="container-bp max-w-3xl">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-white mb-10">Termos de Uso</h1>
        <div className="prose prose-invert max-w-none space-y-6 text-white/60 leading-relaxed">
          <p>Em breve publicaremos os termos completos de uso da plataforma Blue Panda Travel.</p>
