...
const upcoming = [
  ...
  { label: "F1 Grand Prix de Monaco", local: "Monte Carlo" },
  { label: "Flag World Championship", local: "Brasil" },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <motion.div
                ...
                className="inline-flex items-center gap-2 bg-gold/10 border border-gold/30 rounded-badge px-4 py-2 mb-10 mt-8 lg:mt-20"
              >
